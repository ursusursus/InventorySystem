...
public class RoomInventory extends Activity {
	...
	private AlertDialog resetDialog, viewDialog, notFoundDialog, formatNotRecognizedDialog;
		...
		for (Item i : currentRoom.getContentList()) {
			if (i.getID().equals(searchResultID)) {
				if (!(i.isInStock())) {
					...
					itemAlreadyInStockDialog(i.getDesc());
					return;
				}
			}
			position++;
	...
	private void itemDetailsDialog(Item i) {
	...
	private void itemFoundDialog(String name) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		...
		builder.setNeutralButton("Dismiss", new DialogInterface.OnClickListener() {
			...
			@Override
			public void onClick(DialogInterface dialog, int which) {
				gridView.smoothScrollToPosition(itemIndex);
				adapter.notifyDataSetChanged();// refresh listView
	...
	private void itemNotFoundDialog() {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("Failed");
		builder.setMessage("Item not found in this room.");
	...
	private void itemAlreadyInStockDialog(String name) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("Warning");
		builder.setMessage("Item '" + name + "' was already scanned.");
		builder.setPositiveButton("Retry", new DialogInterface.OnClickListener() {
	...
	private void updateInStockItemCount() {
		itemCount.setText(String.valueOf(currentRoom.getInStockCount()));
	}

	private void formatNotRecognizedDialog() {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("Failed");
		builder.setMessage("QR code isn't in correct Inventory System format");
		builder.setPositiveButton("Retry", new DialogInterface.OnClickListener() {
		...
		builder.setNegativeButton("Dismiss", null);
		formatNotRecognizedDialog = builder.create();
		formatNotRecognizedDialog.show();
	}
